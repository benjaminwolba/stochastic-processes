...
\documentclass{/home/ben/Templates/notebook}
...
Living systems can violate the fluctuation-dissipation theorem, the fluctuation-dissipation theorem is a hallmark of equilibrium systems.

\section{Detailed Balance}

A system that can reach equilibrium and which then has a zero net current obeys to so-called detailed balance. It means, that it is not possible to distinguish whether a dynamics is played forwards or backwards in time. It defines reversible Markov chains.
